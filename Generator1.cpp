...
{
    //randamas daleles skersmuo.
    cell_size = 2 * R;

    //priskiriamas spindulio dydis.
    Radius = R;
    ...
    //randamas daleliu kiekis, kuris telpa i pasirinktose ribose.
    Nz = (z2 - z1) / cell_size;
    Ny = (y2 - y1) / cell_size;
    Nx = (x2 - x1) / cell_size;
 ...
 void Generator1::SaveToFileVTK()
 {
    ...
    //sukuriamas VTK masyvas - Particle fix.
    ...
    //sukuriamas VTK masyvas - Particle material.
    ...
    //sukuriamas VTK masyvas - Velocity.
    vtkDoubleArray *Velocity = vtkDoubleArray::New();
    Velocity->SetNumberOfComponents(3);
    Velocity->SetName("VELOCITY");
    Velocity->SetNumberOfTuples(x_Points.size());

    //sukuriamas VTK masyvas - Unique Radius.
    ...
    //sukuriamas VTK masyvas - Distance.
    vtkDoubleArray *Distance  = vtkDoubleArray::New();
    Distance->SetNumberOfComponents(1);
    Distance->SetName("DISTANCE");

    //sukuriamas VTK deleliu masyvas.
    vtkCellArray *cells = vtkCellArray::New();

    //talpinamos reiksmes i masyvus.
